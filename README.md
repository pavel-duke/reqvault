...
> Версия `0.9.0` — release candidate перед стабильной 1.0. Формат workspace v1 зафиксирован, но финальная проверка совместимости ещё продолжается.
...
- полная переработка интерфейса и собственная дизайн-система;
- стабильная политика совместимости workspace v1;
- onboarding, документация, performance и security audit;
- реальные скриншоты готового приложения в README.
