...
> Версия `0.4.0` — рабочая preview-версия. Формат файлов имеет номер версии, но до `1.0` обратная совместимость ещё не гарантируется.
...
- отдельный режим GraphQL;
- редактор query и variables;
- понятное отображение GraphQL errors.
