...
**[Скачать последнюю версию для Windows](https://github.com/pavel-duke/reqvault/releases/latest)**

> Версия `0.8.0` — рабочая preview-версия. Формат файлов имеет номер версии, но до `1.0` обратная совместимость ещё не гарантируется.
...
- диагностика и миграции workspace;
- резервные копии и атомарная запись файлов;
- восстановление сессии и внешние изменения.
