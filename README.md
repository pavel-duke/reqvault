...
> Версия `0.7.0` — рабочая preview-версия. Формат файлов имеет номер версии, но до `1.0` обратная совместимость ещё не гарантируется.
...
- сравнение и структурный diff ответов;
- безопасный экспорт response и HAR;
- поиск, fixtures и просмотр бинарных форматов.
