...
> Версия `0.3.0` — рабочая preview-версия. Формат файлов имеет номер версии, но до `1.0` обратная совместимость ещё не гарантируется.
...
- проверки ответа и запуск коллекций;
- CLI для локального запуска и CI;
- отчёт с понятным exit code.
