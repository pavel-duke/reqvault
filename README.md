...
- нет истории ответов и фонового сохранения ответа на диск;
...
- `0.2`: импорт cURL/OpenAPI, proxy и улучшение коллекций;
- `0.3`: OAuth 2.0, custom CA и mTLS;
- позже: история по явному согласию, скрипты до/после запроса и командные workspace.

Roadmap описывает планы, а не обещанные сроки.
